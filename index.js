...
var stat = require('@ddrive/core/lib/messages').Stat
...
module.exports = function (dir, opts) {
  ...
  return {
    metadata: function (name, opts) {
      ...
      if (name === 'secret_key') return secretStorage(opts.secretDir)(path.join(dir, prefix + 'metadata.ogd'), {key: opts.key, revelationKey: opts.revelationKey})
      return raf(path.join(dir, prefix + 'metadata.' + name))
    },
    content: function (name, opts, vault) {
      if (!vault) vault = opts
